...
function SearchResultsPredictiveCollections({
  ...
  return (
    <div className="predictive-search-result mt-4" key="collections">
      <h5 className='playfairsb text-[19px]'>Collections</h5>
          ...
          return (
            <li className="predictive-search-result-item" key={collection.id}>
              <Link onClick={closeSearch} to={collectionUrl}>
                ...
                <div className='outfit text-[17px] font-regular'>
...
function SearchResultsPredictiveProducts({
  ...
  return (<>
    {/* <span className='text-primary pl-2 text-[18px] playfairsb'>products</span> */}
    {/* <div className=' min-h-[calc(100vh-160px)]'> */}
      <div className="predictive-search-results grid mt-3 grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
        {products.map((product) => {
          ...
          return (
            <SearchCard
              ...
              image={image ? image.url : "/placeholder.svg?height=300&width=300"}
              category={category}
              to={productUrl}
              onClick={closeSearch}
            />
