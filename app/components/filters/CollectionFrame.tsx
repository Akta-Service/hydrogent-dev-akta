              ...
              <div className="flex flex-wrap gap-4">
                {diamondColorCollections.map(({title, handle, image}) => (
                  <button
                    key={handle}
                    onClick={() => {
                      handleColorSelect(handle);
                      toggleSection('metal'); // Close the dropdown after selection
                    }}
...
${selectedColor === handle ? 'ring-1 ring-black' : ''}`}
        ...
        <div className="relative" ref={styleRef}>
          ...
          >
            <div className="text-left outfit font-light">
              <div className="text-[13px] leading-[15px] text-black">Style</div>
              <div className="text-black text-[14px] leading-[16px]">
                {getSelectedLabel(
                  'style',
                  selectedStyle,
